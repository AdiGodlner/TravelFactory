		...
		<ul class="vacation-list">
			<li v-for="v in filteredVacations" :key="v.id" class="vacation-row">
				...
				<div v-if="v.status === 'pending'" class="actions">
					<button class="success-btn" @click="approve(v.id)">Approve</button>

					<button class="danger-btn" @click="openRejectDialog(v.id, $event)">
						Reject
					</button>
				</div>
		...
		>
			<div class="dialog layout-center">
				...
				<div class="modal-actions">
					<button class="danger-btn" @click="confirmReject">
						Confirm Reject
					</button>
